...
//
//**********************************************************************************************************
//  (i) getVehiclePostion();--> no arguments -  returns the ITS's position.
//  
//          example call:
...
//   
//**********************************************************************************************************
//   (j) getTotalMarks(); --> no arguments - returns total marks ITS has traveled.
//   
//          example call:
...
//   
//**********************************************************************************************************
//  (k) getForwardsTotal(); --> no arguments - Returns total number of marks ITS has traveled in the forward 
//                                              direction.
//   
//          example call:
...
//   
//**********************************************************************************************************
//  (l) getBackwardsTotal(); --> no arguments - returns total number of marks ITS has traveled in the reverse 
//                                               direction.
//   
//          example call:
...
//   
//**********************************************************************************************************
//  (m) getVehicleDirection(); --> no arguments - returns direction of ITS.
//   
//          example call:
//            int aevDir = getVehicleDirection(); // Check ITS direction.
