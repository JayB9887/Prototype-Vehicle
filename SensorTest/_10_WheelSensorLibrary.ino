...
//
// Consist of a library of routines that can be used for enhanced ITS coding
 ...
 int getTotalMarks()
{
  ...
  // getTotalMarks();
  //
  // Returns total marks ITS has traveled.
  //
  // Example Call on Routine: 
...
int getBackwardsTotal()
{
  ...
  // getBackwardsTotal();
  //
  // Returns total number of marks ITS has traveled in the reverse direction.
  //
  // Example Call on Routine: 
...
int getForwardsTotal()
{
  ...
  // getForwardsTotal();
  //
  // Returns total number of marks ITS has traveled in the forward direction.
  //
  // Example Call on Routine: 
