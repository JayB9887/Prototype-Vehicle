/*
   ITS sketchbook version 7nA===============================================================
 
 - A list of available function call are listed in detail under tab "_00_ITS_key_words".
 ...
 changes:
 - changed pin assignment to match ITS6 SMC
...
// ---------------------------------------------------------------------------
// Pin definitions (revised pin definitions for ITS6 generation)
// ---------------------------------------------------------------------------
...
const byte buttonBypass  =  A0; // Program start button
const byte sensorLed = 4; //Light sensor led
...
const float lowVolts                 = 6.75;      // Minimum voltage required for ITS operation
...
struct config_t
{
  ...
  unsigned int tMarks;      // Total marks during ITS run. (Cumulative Count)
  int pMarks;               // Position of ITS, in marks.   
} 
configuration;
